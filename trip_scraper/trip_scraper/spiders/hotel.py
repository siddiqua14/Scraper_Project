        ...
        if match:
            try:
                ...
                for hotel in hotel_list:
                    ...
                    hotel_data = {
                        "city_id": city_id[0] if isinstance(city_id, list) else city_id,
                        "city_name": city_name[0] if isinstance(city_name, list) else city_name,
                        "hotel_id": hotel_basic_info.get("hotelId")[0] if isinstance(hotel_basic_info.get("hotelId"), list) else hotel_basic_info.get("hotelId"),
